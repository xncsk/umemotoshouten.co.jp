...
if( !function_exists('pagination') ){
	function pagination($pages = '', $range = 3){
		...
		if( 1 != $pages ){
			echo "<ol class=\"pagination df df-ai-center df-jc-center\">";
			if( $paged > 2 && $paged > $range+1 && $showitems < $pages ){
				echo "<li class=\"df df-ai-center\"><a href='".get_pagenum_link(1)."'>1</a><span class=\"dib ml10\">&hellip;</span></li>";
			}
			...
			if ( $paged < $pages-1 &&  $paged+$range-1 < $pages && $showitems < $pages ){
				echo "<li class=\"df df-ai-center\"><span class=\"dib mr10\">&hellip;</span><a href='".get_pagenum_link($pages)."'>". $pages ."</a></li>";
			}
			echo "</ol>\n";
		}
	}
