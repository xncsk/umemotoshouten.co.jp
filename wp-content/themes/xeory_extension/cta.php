		...
		<div class="mb30 pb30 bb">
			<?php if(wp_is_mobile()): ?>
				<div class="tab-mb10 tac">
					<a href="tel:<?= MOBILE ?>" class="btn bgleft-main">
						<div class="df df-ai-center df-nowrap"><span class="i-mobile mr5"></span><span>電話する</span></div>
					</a>
				</div>
			<?php else: ?>
				<ul class="sp-dn mb30 df df-jc-between">
					<li class="df df-ai-baseline df-jc-center df-nowrap"><span class="fs2vw i-phone mr5"></span><span class="fs4vw b"><?= TEL ?></span></li>
					<li class="df df-ai-baseline df-jc-center df-nowrap"><span class="fs2vw i-mobile mr5"></span><span class="fs4vw b"><?= MOBILE ?></span></li>
				</ul>
			<?php endif; ?>
